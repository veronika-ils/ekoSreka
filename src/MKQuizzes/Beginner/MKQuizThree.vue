    ...
    <div class="nav">
          <ul>
              ...
              <div class="my-dropdown">
                ...
                <li class=" small"><router-link to="/Eco-Discovery" class="none">    EN  </router-link>  </li>    
           <li class="this small"> <router-link to="/MKEco-Discovery" class="none">   MK </router-link> </li>  
