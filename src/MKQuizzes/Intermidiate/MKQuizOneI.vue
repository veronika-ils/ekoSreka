  ...
  <div class="nav">
        <ul>
            ...
            <div class="my-dropdown">
             ...
             <li class=" small"><router-link to="/Eco-Engagement" class="none">    EN  </router-link>  </li>    
           <li class="this small"> <router-link to="/MKEco-Engagement" class="none">   MK </router-link> </li>  
...
export default {
  ...
  data() {
    return {
      quiz: {
        title: "Еко концепти-Средно ниво",
        questions: [
          {
            question: "Што е биодиверзитет?",
            answers: ["Разновидноста на животот во екосистемот", "Бројот на растенија во градината",
            "Вид на загадување", "Метод за управување со отпад"],
            correctAnswer: "Разновидноста на животот во екосистемот",
          },
          {
            question: "Која е главната причина за закиселување на океаните?",
            answers:["Зголемено ниво на јаглерод диоксид", "Прекумерен риболов", "Загадување со пластика", "Излевање нафта"],
            correctAnswer: "Зголемено ниво на јаглерод диоксид",
          },
          {
            question: "Што е одржливо земјоделство?",
            answers: ["Земјоделство што ги троши ресурсите", "Земјоделство кое користи само хемикалии", "Земјоделство кое се фокусира само на високи приноси", "Земјоделство кое одржува здрави екосистеми"],
            correctAnswer: "Земјоделство кое одржува здрави екосистеми",
          },
          {
            question: "Што е губење на живеалиште?",
            answers: ["Уништување на шумите", "Загадување", "Урбан раст", "Сите горенаведени"],
            correctAnswer: "Сите горенаведени",
          },
          {
            question: "Точно или неточно: Рециклирањето на алуминиум заштедува 95% од енергијата потребна за производство на нов алуминиум од суровини.",
