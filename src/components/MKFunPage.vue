    ...
    <div class="nav">
        <ul>
            ...
            <div class="dropdown">
             ...
             <li class="small" ><router-link to="/FunPage" class="none">    EN  </router-link>  </li> 
            <li class="this small"><router-link to="/MKFunPage" class="none">MK</router-link></li>
     ...
     <div class="parts">
    <router-link to="/MKVideoPage" class="none">
         <p>Видео</p>
    </router-link>
       
     </div>
     <div class="parts">
        <router-link to="/MKFotoPage" class="none">
          <p>Фото</p>   
        </router-link>
       
     </div>
     <div class="parts last">
        <router-link to="/MKBasicStarPage" class="none">
          <p>Хороскоп</p>   
        </router-link>
