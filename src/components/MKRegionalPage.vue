<template>
        ...
        <ul>
          ...
          <li class="lang"><router-link to="/Regional" ><img src="../img/uk.webp"></router-link></li>
            <li class=" lang"><router-link to="/MKRegional" ><img src="../img/mkd.png"></router-link></li>
