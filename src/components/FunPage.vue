    ...
    <div class="nav">
        <ul>
            ...
            <div class="dropdown">
             ...
             <li class="this small"><router-link to="/FunPage" class="none">    EN  </router-link>  </li>    
           <li class="small"> <router-link to="/MKFunPage" class="none">   MK </router-link> </li>
     ...
     <div class="parts">
    <router-link to="/VideoPage" class="none">
         <p>Video</p>
    </router-link>
       
     </div>
     <div class="parts">
        <router-link to="/FotoPage" class="none">
          <p>Photo</p>   
        </router-link>
       
     </div>
     <div class="parts last">
        <router-link to="/BasicStarPage" class="none">
          <p>Star signs</p>   
        </router-link>
